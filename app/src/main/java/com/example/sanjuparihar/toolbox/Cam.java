...
public class Cam extends AppCompatActivity implements Camera.FaceDetectionListener,Camera.OnZoomChangeListener,Camera.AutoFocusCallback,
   ...
   private Size previewsize;
    ...
    public Button getpicture,VideoBtn,viewPhotos;
    boolean isflash = false;
    boolean isOn=false;
    ImageButton flashon,flashoff;
   ...
   static {
    ...
    public void init() {
        VideoBtn = (Button) findViewById(R.id.RecordVideo);
        ...
        viewPhotos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent galleryIntent = new Intent(Cam.this,PhotoGallery.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flashoff = (ImageButton) findViewById(R.id.flash_off);
        ...
        flashon = (ImageButton) findViewById(R.id.flash_on);
